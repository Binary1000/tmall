...
public class FacilityList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = "select id,item_编号 as number,item_名称 as name from mm.tlk_生活设施性能 where 1 = 1";
		if(company != null) {
			sql += " and item_单位 = (Select id from obpm.t_department where  name ='" + company + "') ";
		}
		if(category != null) {
			sql += " and item_设施类型 ='" + category +"'";
		}
		if(keyword != null) {
			sql += " and item_名称 like '%" + keyword +"%'";
		}
